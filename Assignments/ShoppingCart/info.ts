...
var itemNames:string[]=["Iphone XR","Samsung Plus","Xperia M","Nokia Flip", "Landline", "BlueBerry"];
var itemPrice:number[]=[1200,950,550,50,75, 220];
var rowNum = 0;
var cartNum:number = localStorage.length.valueOf()
var keys = cartNum; 
...
function printTable(){
   var sum = 0; 
    for(i = 0; i < cartNum; i++){
       ...
       var table: HTMLTableElement = <HTMLTableElement> document.getElementById("L2");
       console.log(table)
    ...
    document.write("<h3 class = 'center'> The sum is : " + sum + "</h3>")
}
...
for (var i = 0; i< 6; i++){
    ...
    var table: HTMLTableElement = <HTMLTableElement> document.getElementById("L1");
    console.log(table)
    var body = table.getElementsByTagName("tbody")[0];
